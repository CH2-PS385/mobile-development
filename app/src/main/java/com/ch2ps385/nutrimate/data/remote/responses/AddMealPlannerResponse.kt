...
data class AddMealPlannerResponse(

	@field:SerializedName("nutrition")
	val nutrition: PostNutritionItem,

	@field:SerializedName("data")
	val data: List<PostDataMealPlanner>,
...
data class PostDataMealPlanner(
